pipeline
{
    ...
    stages
    {
        ...
        stage('Run')
        {
            steps
            {
                bat 'C:/Users/ruiro/AppData/Local/Programs/Python/Python311/python.exe "militar_app/app.py"'
            }
        }
        stage('Executar Testes')
        {
            steps
            {
                bat 'C:/Users/ruiro/AppData/Local/Programs/Python/Python311/python.exe "militar_app/teste.py"'
            }
        }
